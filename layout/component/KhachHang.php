...
<div class="kh">     
    <form id="form_tk" action="/layout/component/KhachHang.php" method="GET">
        ...
        <button type="submit" style="border: solid 1px; background-color:aquamarine ;  border-radius:5px"><i class="fa-solid fa-magnifying-glass" style="padding-top: 10px;padding-right:10px ; padding-left:10px"></i> </button>
        </div>
        ...
        if ($result->num_rows > 0) {
            ...
            $statusColor = ($num['status'] == 1) ? 'green' : 'gray';
                ...
                echo '<td>' . '<div class="item">'
                 . '<div class="icon"> <i class="fa fa-edit btn-sua" 
